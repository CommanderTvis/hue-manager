...
private class WasmJsSessionStorageBackend : SessionStorageBackend {
...
actual fun createSessionStorageBackend(): SessionStorageBackend = WasmJsSessionStorageBackend()
